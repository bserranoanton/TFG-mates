...
\begin{figure}[t]
	...
	\begin{tabular}{cc}
		...
		& \subfloat [Simulación: caso de tolerancia al patógeno en el modelo macroscópico. Parámetros: $\alpha=0.4$, $\beta=0,008$, $k=0.25$, $\lambda=0.2$, $P_m = 0$.]{
			\label{fig:macro_intolerance_osci}
