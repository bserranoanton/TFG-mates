...
rec_vector_N_eff(rec_ind) = N_init;     %Asymetric division of naive T cells
rec_vector_N_mem(rec_ind) = N_init;     %Asymetric division of naive T cells
...
set(gca,'YTickLabel',[]); %Para que no salgan los numeros del eje
set(gca,'XTickLabel',[]);
