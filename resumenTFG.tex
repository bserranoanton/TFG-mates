...
\begin{document}
	...
	\xout{La habilidad de nuestro sistema inmune para combatir antígenos, ya sean internos (como un tumor) o externos (como una infección por microbios) es ciertamente apasionante. }
