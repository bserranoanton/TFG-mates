...
<<<<<<< HEAD:simulaciones de prueba/figura8_codigo.txt
...
=======
lambda = 0.05;%0.04;               %Change rate in membrane receptor Rd, due to Rp signals
k = 0.05;
>>>>>>> 4eaa4bffd41cebe0ae0fc3471e740d425471093d:simulaciones de prueba/macroscopico/macro_v1.m

%Define the final time we will simulate to
T_final = 25;

%Define the initial number of particles
T_init = 25;                    %T will represent T cells                
P_init = 5;                     %P will represent pathogen
...
rec_vector_N_eff(rec_ind) = N_init;     %Asymetric division of na√Øve T cells
rec_vector_N_mem(rec_ind) = N_init;     %Asymetric division of na√Øve T cells
=======
rec_vector_T = -ones(1,num_rec_steps);    %For effector T cells
rec_vector_P = -ones(1,num_rec_steps);    %For pathogen

%Write the initial condision to these vectors
rec_vector_N_eff(rec_ind) = T_init;     %Asymetric division of naÔve T cells
>>>>>>> 4eaa4bffd41cebe0ae0fc3471e740d425471093d:simulaciones de prueba/macroscopico/macro_v1.m
...
=======
set(gca,'YTickLabel',[]); %Para que no salgan los n˙meros del eje
set(gca,'XTickLabel',[]);
legend([hA1,hA3,hA2],'CÈlulas T efectoras','CÈlulas T de memoria','PatÛgeno');
xlabel('tiempo');  ylabel('N˙mero de cÈlulas');
>>>>>>> 4eaa4bffd41cebe0ae0fc3471e740d425471093d:simulaciones de prueba/macroscopico/macro_v1.m
