...
rec_vector_X(1,:)=X_init*ones(1,M);
    ...
    rec_vector_X(2:end,:)=D*sqrt(delta_t)*cumsum(randn(num_rec_steps,M),1)+cumsum(delta_t*ones(num_rec_steps,M),1);
    ...
    [hXd]=plot(time_vec,delta_t*[0:1:num_rec_steps],'k--','linewidth',5);
