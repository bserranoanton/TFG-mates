...
%of the production and degradation example
%By Kit Yates
%Created 25/08/15
...
exportfig(gcf,...
            ['production_degradation_stationary_PDF.eps'],...
            'Format','eps2',...
            'Width','20',...
            'Color','cmyk',...
            'Resolution',300,...
...
%             'LineWidth',6);
        ...
        saveas(gcf,['production_degradation_stationary_PDF.fig'],'fig');